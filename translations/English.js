...
export const English = {
  ...
  inputFieldHeadlinePlaceholder: "Enter headline",
  inputFieldDescription: "Description",
  inputFieldDescriptionPlaceholder: "Enter description",
  inputFieldEvent: "Event",
  inputFieldEventPlaceholder: "Enter event title e.g. Christmas",
  inputFieldDate: "Datum",
  inputFieldDatePlaceholder: "Enter Date e.g. (DD.MM.YYYY)",
  inputFieldDateError: "Wrong Format (DD.MM.YYYY)",
  inputFieldDatePickerSelectSingle: "Select a date",
  inputFieldDatePickerSelectMultiple: "Select your dates",
  inputFieldDatePickerSelectRange: "Select a range of dates",
  inputFieldDatePickerWrongFormat: "Wrong format for date, should be: ",
  inputFieldDatePickerMustBeHigher: "Wrong format for date, must be higher: ",
  inputFieldDatePickerMustBeLower: "Wrong format for date, must be lower: ",
  inputFieldDatePickerMustBeBetween: "Wrong format for date, must be between: ",
  inputFieldDatePickerDisabledDate: "Date cant be selected, its disabled",
  inputFieldDatePickerPrevious: "Previous",
  inputFieldDatePickerNext: "Next",
  inputFieldDatePickerTypeInDate: "Enter your date",
  inputFieldDatePickerPickFromCalender: "Select date from calender",
